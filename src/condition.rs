...
// TODO: fail if cost is greater than this
...
pub struct ThresholdCondition<C: Condition> {
    pub threshold: usize,
    pub subconditions: Vec<C>,
    pub cost: usize
}

pub struct RsaCondition { pub modulus: Bytes, pub cost: usize }

pub struct Ed25519Condition { pub public_key: Bytes, pub cost: usize }
